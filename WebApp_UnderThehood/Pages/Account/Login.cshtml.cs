...
public class LoginModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var claims = new List<Claim> { new (ClaimTypes.Name, "admin"), new (ClaimTypes.Email, "admin@website.com"), new ("Department", "HR"), new ("Admin", "true"), new ("Manager", "true"), new ("EmploymentDate", "2024-11-01")};
